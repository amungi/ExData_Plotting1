...
# Create histogram of "Global Active Power (kilowatts)" measured against its frequency

# Output to file "plot1.png"

png(file = "plot1.png", width = 480, height = 480, units = "px", bg = "white")
par(mfrow = c(1,1), mar = c(5,4,4,2))
hist(epc2007_df$Global_active_power, col = "red", xlab = "Global Active Power (kilowatts)", main = "Global Active Power")
dev.off()
